  ...
  tasks: [
    {
      ...
      description:
        "Initialize the project repository and set up the development environment with Vite, React, TypeScript, and Phaser 3.",
      status: "done",
      dependencies: [],
      priority: "high",
      details:
      ...
      subtasks: [
        {
          ...
          description:
            "Design and implement the PlayerStats class with proper TypeScript interfaces for all player attributes and methods",
          dependencies: [],
          details:
            "Define interfaces for base stats (strength, dexterity, intelligence, etc.), derived stats (health, mana, damage), and implement the PlayerStats class with proper type safety. Include methods for stat calculation, modification, and validation. Use private properties with getters/setters where appropriate.",
          status: "done",
        },
        {
          id: 2,
          ...
          description:
            "Create a flexible experience and leveling system with configurable progression curves",
          dependencies: [1],
          details:
            "Implement XP accumulation, level-up detection, and stat point allocation on level-up. Design a configurable XP curve formula. Create interfaces for level requirements and rewards. Include methods for gaining XP, calculating level from XP, and determining available stat points. Add event emitters for level-up events.",
          status: "done",
        },
        {
          id: 3,
          ...
          description:
            "Create a comprehensive game state management system with proper TypeScript typing",
          dependencies: [1, 2],
          details:
            "Define interfaces for all game state components (player, enemies, world, inventory, quests, etc.). Implement state transitions with proper validation. Create a GameState class that manages the overall state with type-safe access patterns. Include methods for saving/loading state snapshots.",
          status: "done",
        },
        {
          id: 4,
          ...
          description:
            "Create a persistence layer using LocalStorage with proper serialization/deserialization",
          dependencies: [3],
          details:
            "Implement save/load functionality using LocalStorage. Create serialization/deserialization helpers for complex objects. Add versioning for saved data to handle migrations. Implement auto-save functionality with configurable intervals. Include error handling for storage quota exceeded and data corruption scenarios.",
          status: "done",
        },
        {
          id: 5,
          ...
          description:
            "Configure Redux Toolkit with proper TypeScript typing for the game state",
          dependencies: [3],
          details:
            "Set up Redux Toolkit with configureStore. Define RootState and AppDispatch types. Create typed hooks (useAppDispatch, useAppSelector). Implement middleware for logging, thunks, and persistence. Configure the Redux DevTools extension for development debugging.",
          status: "done",
        },
        {
          id: 6,
          ...
          description:
            "Implement Redux Toolkit slices for various game state components with proper typing",
          dependencies: [5],
          details:
            "Create separate slices for player, inventory, combat, quests, and world state. Implement reducers and actions for each slice using createSlice. Define selectors for derived state. Use proper TypeScript typing throughout. Implement thunks for async operations like saving/loading.",
          status: "done",
        },
        {
          id: 7,
      ...
      subtasks: [
        {
          ...
          description:
            "Design and implement the Equipment class with properties for stats, requirements, and equipment slots",
          dependencies: [],
          details:
            "Define the Equipment class with properties for name, type, slot, stat bonuses, level requirements, and other attributes. Include methods for checking if a player meets requirements to equip items. Create an enum for equipment slots (Head, Chest, Legs, etc.) and equipment types.",
          status: "done",
        },
        {
          id: 2,
          ...
          description:
            "Create logic to validate if a player meets the requirements to equip specific items",
          dependencies: [1],
          details:
            "Develop functions to check if player stats meet minimum requirements for equipment. Include level requirements, stat requirements (strength, intelligence, etc.), and any special conditions. Integrate with the existing PlayerStats and PlayerLevel systems to perform validation checks.",
          status: "done",
        },
        {
          id: 3,
        ...
        },
        {
          ...
          description:
            "Create user interface for players to allocate stat points earned through leveling",
          dependencies: [4],
          details:
            "Design and implement UI components for stat allocation, showing current stats, available points, and allowing players to distribute points. Include visual feedback for stat changes and validation to prevent invalid allocations. Ensure the UI updates when stats change from equipment or leveling.",
          status: "done",
        },
        {
          id: 6,
          ...
          description:
            "Connect the existing PlayerLevel system with new progression components",
          dependencies: [4, 5],
          details:
            "Extend the PlayerLevel system to grant stat points on level up. Implement events or callbacks that trigger when a player levels up to update UI, grant rewards, and potentially unlock new equipment options. Create a cohesive flow between leveling, stat allocation, and equipment requirements.",
          status: "done",
        },
        {
          id: 7,
          ...
          description:
            "Implement Immer for immutable state management across the progression system",
          dependencies: [3, 4, 6],
          details:
            "Set up Immer to handle state updates for player stats, inventory, and equipment in an immutable way. Create producer functions for all state-changing operations. Ensure proper state management when equipping items, allocating stats, and leveling up to maintain data integrity and enable features like undo/redo.",
          status: "done",
        },
      ],
    },
    {
      ...
      subtasks: [
        ...
        },
        {
          ...
          description:
            "Create a system for handling projectile-based attacks, including physics calculations for trajectory, collision, and impact effects.",
          dependencies: [1],
          details:
            "Support various projectile types (arrows, bullets, magic bolts), implement launch mechanics, and ensure projectiles interact correctly with the environment and characters.",
          status: "done",
        },
        {
          id: 3,
          ...
          description:
            "Design and implement AOE attack mechanics, including targeting, effect radius, and damage application over an area.",
          dependencies: [1, 2],
          details:
            "Handle visual indicators for AOE zones, apply effects to all entities within range, and manage overlapping AOE interactions.",
          status: "done",
        },
        {
          id: 4,
        ...
        },
        {
          ...
          description:
            "Develop robust input handling for all combat actions, ensuring responsive and intuitive controls for melee, projectile, and AOE attacks.",
          dependencies: [1, 2, 3, 4],
          details:
            "Map player inputs to combat actions, support input buffering and combos, and handle edge cases such as simultaneous actions or input conflicts.",
          status: "done",
        },
      ],
    },
      ...
      subtasks: [
        {
          ...
          description:
            "Create a base abstract class that defines common properties and methods for all enemy types, such as health, movement, and basic attack interface.",
          dependencies: [],
          details:
            "Specify virtual methods for behaviors to be overridden by subclasses. Include basic state management and event hooks.",
          status: "done",
        },
        {
          id: 2,
          ...
          description:
            "Develop the Wraith enemy class inheriting from the abstract Enemy class, implementing unique attributes and behaviors.",
          dependencies: [1],
          details:
            "Define Wraith-specific stats, movement (e.g., phasing or teleporting), and attack logic.",
          status: "done",
        },
        {
          id: 3,
          ...
          description:
            "Develop the Iron Golem enemy class with its own unique properties and behaviors, extending the abstract Enemy class.",
          dependencies: [1],
          details:
            "Include heavy armor, slow movement, and powerful melee attacks.",
          status: "done",
        },
        {
          id: 4,
          ...
          description:
            "Create the Carrion Bats enemy class, inheriting from the abstract Enemy class and implementing swarm and flight behaviors.",
          dependencies: [1],
      ...
      subtasks: [
        {
          ...
          description:
            "Create the foundational class hierarchy for the Village and Shop system, including base classes and inheritance structure.",
          dependencies: [],
          details:
            "Design and implement the base Village class and Shop interface. Create specialized shop classes (Blacksmith, Apothecary, Tavern) that inherit from the Shop base class. Define relationships between classes using appropriate design patterns like Strategy or Decorator. Document class responsibilities, properties, and methods.",
          status: "done",
        },
        {
          id: 2,
          ...
          description:
            "Develop a robust inventory system for shops and player interaction.",
          dependencies: [1],
          details:
            "Create inventory classes for tracking items in shops and player inventory. Implement methods for adding, removing, and updating items. Design data structures for storing item information (name, description, price, effects, etc.). Develop filtering and sorting capabilities for inventory display. Include quantity tracking and stock management for shop inventories.",
          status: "done",
        },
        {
          id: 3,
          ...
          description:
            "Create the economic system for buying and selling items between player and shops.",
          dependencies: [1, 2],
          details:
            "Implement currency management for player gold. Create transaction methods for purchasing and selling items. Add validation logic to ensure sufficient funds and inventory space. Develop price modifiers based on player reputation or game events. Include transaction history tracking for debugging and player reference.",
          status: "done",
        },
        {
          id: 4,
          ...
          description:
            "Implement progression-based shop unlock system with requirements and validation.",
          dependencies: [1],
          details:
            "Design unlock requirements for each shop type (quests, level, items, etc.). Implement validation logic to check if unlock conditions are met. Create visual indicators for locked/unlocked shops. Develop notification system for newly unlocked shops. Include persistence of unlock states across game sessions.",
          status: "done",
        },
        {
          id: 5,
          ...
          description:
            "Create specialized functionality for the Tavern to provide health regeneration services.",
          dependencies: [1],
          details:
            "Design HP regeneration mechanics (instant vs. over time). Implement cost calculation based on amount healed. Create visual feedback for healing process. Add cooldown or usage limitations if needed. Integrate with player health system and ensure proper synchronization.",
          status: "done",
        },
        {
          id: 6,
          ...
          description:
            "Create React components for displaying and interacting with the shop system.",
          dependencies: [1, 2, 3],
          details:
            "Design and implement shop interface components (shop menu, item list, item details). Create transaction UI elements (buy/sell buttons, confirmation dialogs). Develop inventory display components with filtering and sorting. Implement visual feedback for successful/failed transactions. Ensure responsive design for different screen sizes.",
          status: "done",
        },
        {
          id: 7,
        ...
        },
        {
          ...
          description:
            "Create a state management solution using React Context API for shop data and interactions.",
          dependencies: [6],
          details:
            "Design Context providers for shop state (inventory, prices, availability). Implement reducers for handling shop-related actions. Create custom hooks for accessing shop functionality. Ensure proper state updates and re-rendering optimization. Implement persistence of shop state across game sessions.",
          status: "done",
        },
        {
          id: 9,
          ...
          description:
            "Create comprehensive user journeys for all shop-related player interactions.",
          dependencies: [3, 4, 5, 6, 7],
          details:
            "Document all possible player interactions with shops. Create flowcharts for buying, selling, and special services. Implement proper error handling and user feedback. Design intuitive UI navigation between different shop sections. Add tooltips and help information for new players.",
          status: "done",
        },
        {
          id: 10,
          ...
          description:
            "Develop and execute thorough testing for all shop system components.",
      ...
      subtasks: [
        {
          ...
          description:
            "Create a robust Quest class to encapsulate quest data, states, objectives, and completion logic.",
          dependencies: [],
          details:
            "Define quest properties (ID, title, description, objectives, state, rewards). Implement state tracking (active, completed, failed) and support for optional/required objectives.",
          status: "pending",
        },
        {
          id: 2,
          ...
          description:
            "Build a QuestManager to handle quest registration, activation, progression, and completion.",
          dependencies: [1],
          details:
            "Manage active and completed quests, trigger quest events, and interface with other systems for quest updates.",
          status: "pending",
        },
        {
          id: 3,
          ...
          description:
            "Create QuestGiver entities that can assign quests to players and interact with the QuestManager.",
          dependencies: [1, 2],
          details:
            "Allow NPCs or objects to offer quests, check quest prerequisites, and trigger dialogue or UI prompts.",
          status: "pending",
        },
        {
          id: 4,
          ...
          description:
            "Extend the Quest and QuestManager systems to allow quests to be repeatable with configurable cooldowns or limits.",
          dependencies: [1, 2],
          details:
            "Track repeat counts, reset quest state after completion, and handle reward redistribution for repeatable quests.",
          status: "pending",
        },
        {
          id: 5,
          ...
          description:
            "Enable support for quest chains, where completing one quest unlocks subsequent quests.",
          dependencies: [1, 2, 3],
          details:
            "Define quest dependencies, update QuestManager to unlock new quests upon completion of prerequisites, and ensure narrative coherence.",
          status: "pending",
        },
        {
          id: 6,
          ...
          description:
            "Design and implement a user interface for displaying active, completed, and available quests.",
          dependencies: [1, 2, 5],
          details:
            "Show quest details, objectives, progress, and rewards. Allow players to track and review quest history.",
          status: "pending",
        },
        {
          id: 7,
          ...
          description:
            "Create a system to distribute rewards upon quest completion, supporting items, experience, currency, or custom rewards.",
          dependencies: [1, 2, 5],
          details:
            "Integrate with inventory and player stats systems. Ensure rewards are granted only once per completion (or per repeat, if repeatable).",
          status: "pending",
        },
        {
          id: 8,
          ...
          description:
            "Implement event-driven quest progression, allowing quests to respond to in-game actions and triggers.",
          dependencies: [1, 2, 3, 5],
          details:
            "Support triggers such as entering areas, defeating enemies, collecting items, or dialogue choices. Ensure events update quest state appropriately.",
          status: "pending",
        },
        {
          id: 9,
          ...
          description:
            "Connect InkJS dialogue system to quest logic for dynamic quest assignment, updates, and branching narrative.",
          dependencies: [3, 5, 8],
          details:
            "Allow dialogue to start, update, or complete quests. Pass quest state to InkJS for conditional dialogue branches.",
          status: "pending",
        },
        {
          id: 10,
          ...
          description:
            "Synchronize quest data and state with Redux for global state management and UI reactivity.",
          dependencies: [2, 6, 7, 8, 9],
          details:
            "Ensure quest progress, log, and rewards are reflected in Redux store. Enable UI components to react to quest state changes.",
          status: "pending",
        },
      ],
    },
      ...
      subtasks: [
        {
          ...
          description:
            "Define the structure and properties of items, including attributes like name, type, stats, stackability, and unique identifiers.",
          dependencies: [],
          details:
            "Ensure the Item class supports extensibility for future item types and behaviors.",
          status: "done",
        },
        {
          id: 2,
          ...
          description:
            "Create a class to manage a collection of Item instances, supporting add, remove, stack, and query operations.",
          dependencies: [1],
          details:
            "Implement logic for inventory limits, slot management, and error handling for invalid operations.",
          status: "done",
        },
        {
          id: 3,
          ...
          description:
            "Design and build React components to visually represent the inventory grid, slots, and items.",
          dependencies: [2],
          details:
            "Ensure the UI updates in real time with inventory changes and supports responsive layouts.",
          status: "done",
        },
        {
          id: 4,
          ...
          description:
            "Enable users to drag items between inventory slots, equipment slots, and other UI elements using React DnD.",
          dependencies: [3],
          details:
            "Handle drag events, drop validation, and visual feedback for valid/invalid drops.",
          status: "done",
        },
        {
          id: 5,
        ...
        },
        {
          ...
          description:
            "Display detailed information about items when hovered over in the inventory or equipment slots.",
          dependencies: [3],
          details:
            "Include item stats, descriptions, and any special effects in the tooltip display.",
          status: "pending",
        },
        {
          id: 7,
          ...
          description:
            "Implement a system allowing players to combine items to create new ones, with UI for recipe selection and result preview.",
          dependencies: [2, 3],
          details:
            "Support recipe validation, ingredient consumption, and output item generation.",
          status: "pending",
        },
        {
          id: 8,
          ...
          description:
            "Assign and render icons or sprites for each item type within the inventory and equipment UI.",
          dependencies: [3],
          details:
            "Ensure visual consistency and clarity for different item categories and rarities.",
          status: "pending",
        },
        {
          id: 9,
          ...
          description:
            "Allow users to sort and filter inventory items by type, rarity, or other attributes through the UI.",
          dependencies: [3],
          details:
            "Implement efficient sorting algorithms and intuitive filter controls.",
          status: "pending",
        },
        {
          id: 10,
          ...
          description:
            "Ensure seamless integration of React DnD with inventory, equipment, and crafting UIs, and test for usability and performance.",
          dependencies: [4, 5, 7],
          details:
            "Address edge cases such as invalid drops, rapid item movement, and accessibility concerns.",
          status: "pending",
        },
      ],
    },
      ...
      subtasks: [
        {
          ...
          description:
            "Create essential HUD elements that display critical gameplay information while maintaining readability and minimal screen clutter.",
          dependencies: [],
          details:
            "Design health/mana bars, score indicators, and inventory quick-access using high-contrast colors and familiar icons. Ensure elements are positioned around screen edges without obstructing gameplay. Implement customizable positioning and scaling options for player preferences. Test readability across different gameplay scenarios.",
          status: "pending",
        },
        {
          id: 2,
          ...
          description:
            "Develop main menu, pause menu, and settings interfaces that work across different platforms and screen sizes.",
          dependencies: [1],
          details:
            "Create consistent visual style across all menu screens. Design for both controller and touchscreen inputs. Implement responsive layouts that adapt to different aspect ratios and device capabilities. Include audio feedback for menu navigation. Ensure menus can be accessed without disrupting gameplay flow.",
          status: "pending",
        },
        {
          id: 3,
        ...
        },
        {
          ...
          description:
            "Create an information system that provides players with contextual help and item descriptions.",
          dependencies: [2, 3],
          details:
            "Design tooltips that appear when hovering over items, abilities, or UI elements. Implement a help system that provides contextual information based on the player's current situation. Ensure tooltips don't obstruct critical gameplay elements. Create a consistent visual style that matches the overall UI theme.",
          status: "pending",
        },
        {
          id: 5,
          ...
          description:
            "Design and integrate a mini-map system that helps players navigate the game world.",
          dependencies: [1],
          details:
            "Create a mini-map that displays the player's current location, objectives, and points of interest. Implement zoom functionality and customization options. Ensure the mini-map is positioned optimally and can be toggled or resized. Design clear icons for different map elements. Test the mini-map's effectiveness across different game environments.",
          status: "pending",
        },
      ],
    },
      ...
      subtasks: [
        {
          ...
          description:
            "Develop a comprehensive data collection and analysis framework to gather player statistics, performance metrics, and gameplay patterns",
          dependencies: [],
          details:
            "Create systems to track player progress, success rates, time spent on challenges, and resource usage. Implement heatmaps for spatial analysis and tools similar to Playtracer to visualize player journeys. Include survey mechanisms and potentially biometric data collection for deeper insights.",
          status: "pending",
        },
        {
          id: 2,
          ...
          description:
            "Create tools that allow designers to adjust game parameters and visualize the impact of changes across game systems",
          dependencies: [1],
          details:
            "Build a mathematical modeling system to express the power of game elements quantitatively. Implement visualization tools to show balance parameters across variations and identify trends. Ensure tools support quick iteration of values while maintaining awareness of cross-system dependencies.",
          status: "pending",
        },
        {
          id: 3,
          ...
          description:
            "Design a structured approach to playtesting that combines traditional observation with data-driven analysis",
          dependencies: [1, 2],
          details:
            "Create protocols for interviews, observation sessions, and feedback collection. Develop methods to analyze the gap between expert and novice play to understand the roles of strategy versus tactics. Implement an iterative testing cycle that incorporates both provisional and true balancing phases.",
          status: "pending",
        },
        {
          id: 4,
          ...
          description:
            "Design and implement mechanisms for adjusting game difficulty based on player performance and progression",
          dependencies: [2, 3],
          details:
            "Create systems for both positive and negative feedback loops to control player progression. Develop algorithms to dynamically adjust challenge levels based on player skill. Ensure difficulty curves maintain player engagement while avoiding dominant strategies and unintended consequences across subsystems.",
          status: "pending",
        },
      ],
    },
      ...
      subtasks: [
        {
          ...
          description:
            "Implement techniques to improve asset loading efficiency, such as asset compression, lazy loading, and dynamic loading strategies to reduce initial load times and memory usage.",
          dependencies: [],
          details:
            "Apply asset compression, use lazy loading for non-critical assets, and consider dynamic loading based on game state or user interaction. Evaluate the use of spritesheets or atlases to minimize draw calls and optimize GPU memory usage.",
          status: "pending",
        },
        {
          id: 2,
          ...
          description:
            "Analyze and optimize rendering methods, including experimenting with different rendering backends (WebGL vs Canvas), culling off-screen objects, and optimizing draw calls.",
          dependencies: [1],
          details:
            "Profile rendering performance across devices, implement object culling, and test switching between WebGL and Canvas to determine the best performance for target devices. Optimize the use of large images and backgrounds to balance quality and memory usage.",
          status: "pending",
        },
        {
          id: 3,
          ...
          description:
            "Implement memory management strategies such as object pooling, removing unused textures, and monitoring GPU memory usage to prevent leaks and ensure smooth gameplay.",
          dependencies: [2],
          details:
            "Set up object pools for frequently created/destroyed objects, ensure textures and assets are unloaded when no longer needed, and monitor memory usage to identify and resolve leaks.",
          status: "pending",
        },
        {
          id: 4,
          ...
          description:
            "Apply React-specific optimizations, including using PureComponent, memoization, virtualizing long lists, and minimizing unnecessary re-renders.",
          dependencies: [3],
          details:
            "Convert suitable components to PureComponent or use React.memo, implement shouldComponentUpdate where appropriate, and use tools like the React Profiler to identify bottlenecks. Virtualize large lists and optimize component structure to reduce reconciliation overhead.",
          status: "pending",
        },
        {
          id: 5,
          ...
          description:
            "Implement strategies to minimize initial and subsequent load times, such as code splitting, service worker caching, and optimizing the production build.",
          dependencies: [4],
          details:
            "Use code splitting to load only necessary code, leverage service workers for caching assets and application state, and ensure the production build is optimized for size and speed. Continuously measure load times and iterate on improvements.",
          status: "pending",
        },
      ],
    },
...
describe("TasksFileContent", () => {
  it("should successfully parse the example data", () => {
    const result = Schema.decodeUnknownEither(TasksFileContent)(example);
    if (result._tag === "Left") {
      console.error("Parsing failed with error:", result.left);
    }
  ...
  it("should handle empty tasks array", () => {
    ...
    const result = Schema.decodeUnknownEither(TasksFileContent)(emptyTasks);
    expect(result._tag).toBe("Right");
  });
  ...
  it("should validate task dependencies correctly", () => {
    ...
    const result =
      Schema.decodeUnknownEither(TasksFileContent)(tasksWithValidDeps);
    expect(result._tag).toBe("Right");
  });
  ...
  it("should reject invalid task dependencies", () => {
    ...
    const result =
      Schema.decodeUnknownEither(TasksFileContent)(tasksWithInvalidDeps);
  ...
  it("should validate subtask dependencies correctly", () => {
    ...
    const result = Schema.decodeUnknownEither(TasksFileContent)(
      taskWithValidSubtaskDeps
    );
    expect(result._tag).toBe("Right");
  });
